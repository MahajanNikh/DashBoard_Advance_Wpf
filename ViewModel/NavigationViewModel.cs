...
/// ViewModel exposes data contained in the Model objects to the View. The ViewModel performs all modifications made to the Model data.
/// </summary>



using DashBoard_Advance.Model;
using DashBoard_Advance.View;
using System;
...
namespace DashBoard_Advance.ViewModel
{
    public class NavigationViewModel : INotifyPropertyChanged
    {
        ...
        {
            //ObservableCollection represent a dynamic data Collection that provides notifications when items
        ...
        public ICommand MenuCommand
        {
            get
            {
                ...
                {
                    _menucommand = new RelayCommand(para => SwitchViews(para));
                }
                return _menucommand;
            }
        }
        ...
        public ICommand ThisPCCommand
        {
            get
            {
                if (_pccommand == null)
                {
                    _pccommand = new RelayCommand(para => PCView());
                }
                return _pccommand;
            }
        }
